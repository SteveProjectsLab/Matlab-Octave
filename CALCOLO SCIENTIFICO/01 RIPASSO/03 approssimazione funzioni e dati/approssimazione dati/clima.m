% temperatura in prox del suolo varia al variare della concentrazione K di
% acido carbonico e dell'altitudine L
clear 
close all
clc
% dati
x=(-55:10:65)'; %altitudine
y=[3.7 3.7 3.52 3.27 3.2 3.15 3.15 3.25 3.47 3.52 3.65 3.62 3.52 ]';    %variazioni temperatura media

% si vuole approssimare roma (L=42 e oslo L=59)
np=length(x);
n=np-1;

x1=linspace(x(1),x(end),500);   % definisco un vettore di punti piu' fitti
%%
...
% interp. globale: Roma=3.553488 Oslo=2.803921
% interp. composita: Roma=3.611000 Oslo=3.580000
% interp. spline: Roma=3.615287 Oslo=3.575768
