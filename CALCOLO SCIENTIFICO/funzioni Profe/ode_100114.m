function [tt,u]=ode_100114(odefun,tspan,y0,Nh,varargin);
%ode_100114  Risolve equazioni differenziali
%   [tn,un] = ode_100114(odefun,tspan,y0,Nh) con
%   TSPAN = [T0,TF] integra il sistema di equazioni
%   differenziali y' = f(t,y) dal tempo T0 a TF con
%   condizione iniziale Y0 su una griglia a passo costante e
%   Nh intervalli.
...
%   [T,Y] = ode_100114(ODEFUN,TSPAN,Y0,NH,P1,P2,...) passa
