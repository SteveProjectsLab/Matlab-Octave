...
%---------------------------------------------------------------------------
% punto 1   CALCOLO PUNTI DI EQUILIBRIO E STABILITA'
%---------------------------------------------------------------------------
...
% 
% [                         -1,    -6*sin(x2)]
% [x2^2 + x2 - u - 6*u*sin(x1), x1*(2*x2 + 1)]
...
% NON è un punto di equilibrio

%aval2 =   -1.0000   -3.2418

%---------------------------------------------------------------------------
% punto 2   LINEARIZZAZIONE NEL PUNTO DI EQUILIBRIO
%---------------------------------------------------------------------------
...
%---------------------------------------------------------------------------
% punto 3   CONTROLLO IN RETROAZIONE
%---------------------------------------------------------------------------
% 3. Determinare un controllo in retroazione dello stato utilizzando il 
% sistema linearizzato attorno a x1 =% [3.2418 − 1], in modo che la dinamica
% definita dagli autovalori [a1;2*a1], dove a1 permetta al sistema
% (considerando la linearizzazione ”perfetta”) 
% di raggiungere l’equilibrio in un tempo T=5s quando u=0.

T=5;
td=T/5;
pd=-1/td;
a1=pd;
K=place(A3,B3,[a1,2*(a1)])
