...
% modulo 
    ...
    semilogx(f, 20*log10(module),'Color', 'g', 'Linewidth', 1.5,'DisplayName','Teorico'),
...
% fase
    ...
    semilogx(f, rad2deg(phase),'Color', 'g', 'Linewidth', 1.5,'DisplayName','Teorico'),
    title('$Arg(H) [deg]$','Interpreter','latex'), 
