...
% In questi punti la funzione e' (1-abs(t)).
% 
...
% Per convertire i boolean in double e' sufficiente mettere un cast,
% ad esempio in questo caso scrivere double(abs(t)<=1). Nell'esempio
% questo non e' fatto perche', moltiplicando per (1-abs(t)), che
...
% In questi punti la funzione e' (1-t).
% *******************************************************************
%
