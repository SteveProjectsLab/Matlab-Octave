...
for n= 1: length(N_Armoniche_Vettore)
    ...
    subplot(2,1,1), stampaCoeff_bk_SerieFourier(calcoloCoefficiente_bk_SerieFourier(x1, N_Arm, T, t, dt), N_Arm)
    subplot(2,1,2), plot(t, x1_approssimato_calc(n,:), t, x1), title (sprintf('x1 ricostruito con b calcolato con l''integrale con %d armoniche', N_Arm))
