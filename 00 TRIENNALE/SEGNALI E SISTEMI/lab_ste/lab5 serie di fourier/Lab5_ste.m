...
%-------------------------------------------------------------------------
fprintf('\nES1 Punto 1\n\n');
fprintf("serie di fourier del segnale rect..\n")
%-------------------------------------------------------------------------
% Fundamental period
T1 = 4;
...
%-------------------------------------------------------------------------
fprintf('\nES1 Punto 2\n\n');
fprintf("sintesi dell'approssimazione\n")
%-------------------------------------------------------------------------
...
%-------------------------------------------------------------------------
fprintf('\nES1 Punto 3\n\n');
fprintf("disegno dell'approssimazione \n")
%-------------------------------------------------------------------------
...
%-------------------------------------------------------------------------
fprintf('\nEs2 Punto 1\n\n');
fprintf("serie di fourier del coseno rettificato\n")
%-------------------------------------------------------------------------
...
for n = 1:length(NarmVet)
    ...
    for k = 1:Narm
        ...
        % fprintf('\nEs3\n\n');
        % fprintf("calcolo dei coefficienti\n")
