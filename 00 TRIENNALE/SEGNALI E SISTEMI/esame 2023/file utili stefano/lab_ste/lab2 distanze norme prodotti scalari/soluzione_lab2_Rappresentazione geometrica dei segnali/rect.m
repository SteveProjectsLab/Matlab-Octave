...
% 
% L'espressione (abs(t)<1/2) "seleziona" i punti compresi tra -1 e 1.
% 
% N.B. - dettaglio tecnico matlab - 
% Le espressioni (abs(t)<=1) e (abs(t)==1/2), usate in questo
% esempio, assumono valori boolean, ovvero solo 1 o 0. 1 indica vero,
...
% (eventualmente "complex"). Per convertire i boolean in double e'
% sufficiente mettere un cast, ad esempio in questo caso scrivere
% double(abs(t)<=1). Nell'esempio questo non e' fatto perche',
% moltiplicando per i numeri reali 1 e 0.5, Matlab effettua il cast
% automaticamente e usa il tipo double per la variabile x.
% ********************************************************************
